...
document.addEventListener("DOMContentLoaded", function() {
  ...
  outputDiv.innerHTML += "<h3>Activity 1: Sorting a list of strings</h3>";
  outputDiv.innerHTML += "<p>Simple Sort: " + simpleSort + "</p>";
  ...
  outputDiv.innerHTML += "<p>Another Sort: " + anotherSort + "</p>";

  // Activity 2: Filtering a list of strings
  function searchListStrings(list, q) {
  ...
  outputDiv.innerHTML += "<h3>Activity 2: Filtering a list of strings</h3>";
  outputDiv.innerHTML += "<p>Search 'b': " + searchListStrings(simpleList, "b") + "</p>";

  // Activity 3: Sorting and Filtering a list of objects
  outputDiv.innerHTML += "<h3>Activity 3: Sorting and Filtering a list of objects</h3>";
  ...
  function displayHikes(hikes, query) {
    outputDiv.innerHTML += `<h4>Search '${query}':</h4>`;
    outputDiv.innerHTML += "<ul>";

    hikes.forEach(hike => {
      outputDiv.innerHTML += `
        <li>
          <strong>${hike.name}</strong> - ${hike.distance}<br>
  ...
  displayHikes(searchList(hikes, "yellowstone"), "yellowstone");
  displayHikes(searchList(hikes, "moderate"), "moderate");
  displayHikes(searchList(hikes, "al"), "al");
});